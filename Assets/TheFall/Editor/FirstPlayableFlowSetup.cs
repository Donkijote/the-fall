...
namespace TheFall.Editor
{
    public static class FirstPlayableFlowSetup
    {
        ...
        private static readonly EntryDefinition[] Entries =
        {
            ...
            Text("flow.home.subtitle", "The Baseline Bot waits at the offline table. Choose the rules, complete one match, and claim victory."),
            ...
            Text("flow.home.prompt", "Begin Quest opens the two rule choices before the table."),
            ...
            Text("flow.home.settings.description", "Match audio and animation controls remain available at the table. Broader account settings arrive with connected services."),
