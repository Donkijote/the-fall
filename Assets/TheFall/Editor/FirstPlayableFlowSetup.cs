...
namespace TheFall.Editor
{
    public static class FirstPlayableFlowSetup
    {
        ...
        private static readonly EntryDefinition[] Entries =
        {
            ...
            Text("flow.home.eyebrow", "OFFLINE PLAYER · READY"),
            Text("flow.home.subtitle", "Outscore the Baseline Bot in one complete match and claim the table."),
            Text("flow.home.card-label", "CURRENT OBJECTIVE"),
            Text("flow.home.objective-title", "Defeat the Baseline Bot"),
            Text("flow.home.mode", "1V1 · 40-CARD DECK"),
            ...
            Text("flow.home.start", "01 · PLAY"),
            Text("flow.home.prompt", "Play opens the two rule choices before the table."),
            Text("flow.home.stat.mode-label", "MODE"),
            Text("flow.home.stat.mode-value", "1V1"),
            Text("flow.home.stat.target-label", "TARGET"),
            Text("flow.home.stat.target-value", "24"),
            Text("flow.home.stat.deck-label", "DECK"),
            Text("flow.home.stat.deck-value", "40"),
